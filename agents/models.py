"""
Pydantic v2 schemas and data definitions for Kidney Transplant Kpi Agent.
...
class AgentAlert(BaseModel):
    ...
    standard_reference: str = "KDIGO / KDOQI Clinical Practice Guidelines"
    timestamp: str = Field(default_factory=lambda: datetime.datetime.now(datetime.timezone.utc).isoformat())
...
class ConsensusDossier(BaseModel):
    dossier_id: str
    system_slug: str = "kidney-transplant-kpi-agent"
    domain: str = "Nephrology & Dialysis Systems"
    task_id: str
