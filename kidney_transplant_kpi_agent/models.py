"""
Clinical Data Models & Enums for KidneyTx Sentinel: KDPI Donor Matching, Delayed Graft Function & Banff Rejection Agent.
...
class AgentAlert:
    ...
    guideline_citation: str = "Banff 2019 Allograft Pathology Consensus"
    timestamp: str = field(default_factory=lambda: datetime.datetime.now(datetime.timezone.utc).isoformat())
